...
Room.create(name: 'Emergency Room', facility_name: 'Hiroshima Red Cross Hospital', location: 'Hiroshima, Japan', equipment: 'Surgical Lights', price_per_hour: 20000, category: 'Emergency Medicine', capacity: '5', user: random_user)
Room.create(name: 'Physical Therapy Room', facility_name: 'Yokohama Rehabilitation Clinic', location: 'Kanagawa, Japan', equipment: 'Fluoroscope', price_per_hour: 9000, category: 'Physical Therapy', capacity: '3', user: random_user)
Room.create(name: 'Neonatal Intensive Care Unit', facility_name: 'Kobe Children’s Hospital', location: 'Hyogo, Japan', equipment: 'Fetal Heart Monitor', price_per_hour: 12000, category: 'Pediatrics', capacity: '2', user: random_user)
Room.create(name: 'Sleep Study Room', facility_name: 'Sapporo Sleep Disorders Clinic', location: 'Hokkaido, Japan', equipment: 'Flexible Endoscope', price_per_hour: 8000, category: 'Sleep Medicine', capacity: '1', user: random_user)
Room.create(name: 'Intensive Care Unit', facility_name: 'Nara General Hospital', location: 'Nara, Japan', equipment: 'Surgical Lights', price_per_hour: 18000, category: 'Critical Care', capacity: '5', user: random_user)
Room.create(name: 'X-ray Room', facility_name: 'Akita Medical Clinic', location: 'Akita, Japan', equipment: 'MRI Scanner', price_per_hour: 7000, category: 'Radiology', capacity: '2', user: random_user)
Room.create(name: 'Infusion Therapy Room', facility_name: 'Kanazawa Medical Center', location: 'Ishikawa, Japan', equipment: 'Flexible Endoscope', price_per_hour: 10000, category: 'Infusion Therapy', capacity: '3', user: random_user)
Room.create(name: 'Orthopedic Operating Room', facility_name: 'Himeji Orthopedic Clinic', location: 'Hyogo, Japan', equipment: 'Surgical Lights', price_per_hour: 16000, category: 'Orthopedics', capacity: '4', user: random_user)
