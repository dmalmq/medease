...
puts "Done creating the hospital rooms.."
=======
Room.create(name: 'Cardiac Catheterization Lab', facility_name: 'Sunrise Medical Center', location: 'Tokyo, Japan', equipment: 'Fluoroscope', price_per_hour: '¥10,000', category: 'Cardiology', capacity: '3')

Room.create(name: 'MRI Suite', facility_name: 'Asahi Hospital', location: 'Osaka, Japan', equipment: 'MRI Scanner', price_per_hour: '¥12,000', category: 'Radiology', capacity: '4')
 
Room.create(name: 'Operating Room', facility_name: 'Sakura Hospital', location: 'Kyoto, Japan', equipment: 'Surgical Lights', price_per_hour: '¥15,000', category: 'Surgery', capacity: '5')
